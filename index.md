...
<body>
  <table width="760" border="0" align="center" cellpadding="0" cellspacing="10"  _bgcolor_="#FFFBEF">
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>
	      ...
	      by the <a href="https://worldvista.org/">WorldVistA</a> open source community.<br>


        This document describes process of creation <i>WorldVistA CPRSChart</i>  -
				client application that provides access to a patient data in WorldVistA EHR system.<br>
        It does not discuss installation or usage of the EHR Server software.

				<p>The version of <i>CPRSChart</i> for WorldVistA EHR 3.1 Ver 3-16
					will be referred as <i>WV-CPRSv3-16</i> in this text.<br>
            <p>
						Document map:
						<p>
            ...
            <a HREF="#INFO">Additional Information</a><br>
      ...
      <td >
        ...
        <ul>
          ...
          <li>Delphi 10.4 (SYDNEY) Professional</li>
				...
				<p>The user should be familiar with basic Delphi:
    ...
    <tr>
      ...
      <td >
        ...
        <em><strong>GUI</strong></em></p>
				...
				The source code of the WVEHR3v2-16 was updated with several enhancements and bug fixes.<br>

        <p><em><strong>CPRS Packages</strong></em></p>
        ...
        You may replace the packages source with the version of </i>30c</i> if prefer to use code 100% compatible withVA CPRS GUI v30c.
  ...
  <tr>
    ...
    <td >
      ...
      It is common to use Delphi for development of several applications using
		  ...
		  Delphi resolve this issue by use of IDE command line <i>-r</i> switch.
			...
			<p>
			The next image illustrates the use of <i>-r</i> switch to start IDE. The sitch value is set to <i>WorldVistA</i>:</p>
		  <p>
      ...
      <a href="http://docwiki.embarcadero.com/RADStudio/Sydney/en/IDE_Command_Line_Switches_and_Options">
				More about Delphi Command Line switches and options</a>
				<p>
      ...
      <p>
			<em><strong>1. Removing previous versions of packages</strong></em></p>
      ...
      <p>
			<img src="installedPackages.PNG"/></a></p>
	...
	<p>
      ...
      By default Delphi saves results of package compilations in the direcory defined by the environment variable <i>BDSCOMMONDIR</i>.
			Changing the default value allows you to control where the compiled packages and other files required for your project compilation will be placed.

			<p><img src="DelphiEnvironment.PNG"/></a>
	<p>
      ...
      Use the environment variable created in step 2 in fields <i>Package output directory</i>, <i>DCP output directory</i>:<p>
	    <img src="DelphiOptionsLibrary.PNG"/></a></p>



      Don't forget to select the correct Compilation Platform <i>Windows 32-bit</i>!<p>
...
<p>
  ...
  <tr>
    ...
    <td >
			...
			Original CPRS GUI v31b was compiled with Dephi XE8. That is why the package names include a reference compiler version.<p>

			The source code of <i>CPRS Packages</i> is kept in the <i>CPRS_Packages_31b</i> directory.
			Location and short description of the individual packages:
...
<table>
	...
	<tr>
			...
			<p><img src="CPRSPackages31bLight.png"/></a><br><p>
    ...
    <td >
      ...
      <img src="GUIProjectLight.png"/></a><br><p>
	    ...
	    Files in this folder were updated to match compiler requirements as definitions of some Delphi 10.3 constants were changed.
		  ...
		  <p>
			Files introduced in <i>WV-CPRSv3-16</i> were placed in the WVEHR folder.
			<p>
      ...
      <ul>
        ...
        <li>List of the files included in the project was changed
  		...
  		<p>
			<table width="100%" border="0">
				<tr><td colspan=2><strong>Files removed from the project <i>CPRSChart.dpr</i>:</strong><p></td></tr>
				<tr>
