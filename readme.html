...
<html>
  ...
  <table width="50%" border="0">
    <tr>
      <td>
        <a href="https://WorldVista.org">
          <img align="right" width=80% src="ReadMe\Globe.png" border="0" /><br>
        </a>
      </td>
    ...
    <tr>
      <td valign="top" align="right"> <a name="DT">
        <em><strong>Development Tools</strong></em></a>
      </td>
	  <td style="background-color:#dddddd;"> </td>
	</tr>
    <tr>
      ...
      <td >
        ...
        In preparation of this document the source code of WV-CPRSv3-16 was
        successfully compiled with 2 versions of Delphi:
        <br>
        <ul>
    ...
    <tr>
      <td valign="top" align="right"><a name="SC">
        <em><strong>Source Code</strong></em></a>
      </td>
	  <td style="background-color:#dddddd;"> </td>
    </tr>
    <tr>
    ...
    <tr>
      <td align="right" valign="top"><em><strong></strong></em> </td>
      <td>
        <em><strong>Before you begin:</strong></em>
        <p>
		...
		The switch value is set to <i>WorldVistA</i>:</p>
        ...
        <table>
		  <tr valign="top">
		    ...
		    <td> If you compiled packages before and have previous versions of the <i>*.bpl</i> files not listed in the
		      "Install Packages" dialog you might need to find and remove them manually.
            </td>
		  </tr>
        </table>
	    <p>
	    <em><strong>2. Setting environment variables to specify location of the compiled packages</strong></em>
        <p>
	    ...
	    Changing the default value allows you to control where the compiled packages
        and other files required for your project compilation will be placed.
        <p>
	    <img src="ReadMe\DelphiEnvironment.PNG"/>
	    <p>
        ...
        <ul>
 		...
 		<p><img src="ReadMe\EditVariable.PNG"/>
        <p>
        <em><strong>3. Updating Delphi Options</strong></em></p>
        Use the environment variable created in step 2 in fields
        <i>Package output directory</i>, <i>DCP output directory</i>:
		<p>
		<p>
		<img src="ReadMe\DelphiOptionsLibrary.PNG"/>
		<p>
        ...
        <p>
 		<img src="ReadMe\DelphiOptionsLibraryDirectories.PNG"/></p>
		<table>
		  <tr valign="top">
		    <td>NOTE:</td>
        ...
        Now it's time to open Package Group containing source code of the CPRS packages.
      </td>
    </tr>
	<tr>
	  <td valign="top" align="right"></td>
    ...
    <tr>
      ...
      <td >
	  	<em><strong>CPRS Packages v31b Project Source</strong></em>
        <p>
        ...
        <br><br>
	      ...
	      <tr>
	        ...
	        <td>
	          ...
	          If you have Broker Patch 65 installed you can use it and ignore installation of
              the version included in <i>CPRS_Packages_31b</i> suite.
	        </td>
	      </tr>
        </table>
      ...
      <table>
	    <tr>
		  <td>Original code :</td>
		  <td>REVOCATION_OID_CRL_REVOCATION = LPCSTR('1');</td>
        </tr>
	    <tr>
		  <td>Modified:</td>
          <td>REVOCATION_OID_CRL_REVOCATION<strong>:LPCSTR</strong> = LPCSTR('1');</td>
        </tr>
      </table>
	  <p>Similar changes should be applied to the next lines of file <i>wcrypt2.pas </i>:</p>
	  <ul>
	  	<li>18054
	  	<li>18344..18355
  ...
  <tr>
    ...
    <td >
	  ...
	  <br><br>
	  <strong>Changes to the project file <i>CPRSChart.dpr</i>:</strong><br>
	  <ul>
	  ...
	  <table border="0">
	  	<tr>
	      <td colspan=2><br><strong>Files removed from the project <i>CPRSChart.dpr</i>:</strong></td>
	    </tr>
	 	<tr>
          ...
          <TR>
            <td>VERGENCECONTEXTORLib_TLB</td><td>Replaced with the one of Broker package</td></TR>
          ...
          <TR><td>  fSplash</td><td>Replaced with 'WVEHR\fAbout.pas'</td></TR>
            <tr><td colspan=2><br>
                <strong>Files included in the project <i>CPRSChart.dpr</i> when conditional WORLDVISTA is defined:</strong>
            </td></tr>
            <tr>
            <td width="20%"><b>File</b></td>
              <td><b>Comment</b></td>
          ...
          <tr><td colspan=2><br>
                <strong>Files included in the project <i>CPRSChart.dpr</i> when conditional WORLDVISTA is <i>undefined</i>:</strong>
              </td>
          </TR>
          <tr>
            <td width="20%"><b>File</b></td>
          ...
          <tr><td colspan=2><br><strong>Files added to the project <i>CPRSChart.dpr</i>:</strong></td></TR>
          <tr>
            <td width="20%"><b>File</b></td>
            <td><b>Comment</b></td>
          </tr>
          ...
          <tr><td  colspan=2><br><strong>Changes to the original <i>.pas</i> files</strong>:</td></TR>
          <tr>
            <td width="20%"><b>File</b></td>
            <td><b>Comment</b></td>
          </tr>
  ...
  <tr>
      ...
      <a name="INFO"><strong>Additional Information</strong></a></td>
  	<td style="background-color:#dddddd;"></td>
  </tr>
  <tr>
    <td align="right" valign="top"><em><strong></strong></em> </td>
