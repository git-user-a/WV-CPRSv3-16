...
uses
  ...
  StdCtrls, DateUtils, ORNet, ORFn, Menus, StdActns, ActnList, ImgList,
  ComCtrls, Tabs, DockTabSet, ToolWin, ExtCtrls
{$IFDEF STANDALONE}
{$ELSE}
  , rMisc
  , fBase508Form
{$ENDIF}
  , Buttons,   ORCtrls, ORSystem,
  VA508AccessibilityManager, VAUtils, System.Actions, System.ImageList
{ $ IFDEF VER180} // DELPHI 2006
  , RichEdit
{ $ ELSE}
//System.UITypes, Winapi.RichEdit, Vcl.Menus, Vcl.ImgList, Vcl.ToolWin
//  System.ImageList, System.Actions, Vcl.ActnList, Vcl.StdActns,
//  Vcl.Tabs, Vcl.DockTabSet, Menus, StdActns, ActnList, ImgList, Tabs,
//  DockTabSet, ToolWin
{ $ ENDIF}
