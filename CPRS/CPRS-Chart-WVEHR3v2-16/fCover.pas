...
begin
  ...
  Align := alClient; // AA refreshing coversheet after update;
end;
...
procedure TfrmCover.FormHide(Sender: TObject);
begin
  inherited;
  timPoll.Enabled := False; // AA - disabling polling on leaving the form
end;
