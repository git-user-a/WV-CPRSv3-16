unit fDiagnoses;
 //AGP WV INTEGRATE CPRS30.70 CHANGES HAD TO DO WITH UPDTING THE ICD SECTION. PLEASE COMPARE THIS
 //FILE TO YOUR FILE. You can use the varibable PLUpdated as a starting pointint.
interface
