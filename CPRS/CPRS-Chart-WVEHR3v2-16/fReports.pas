...
type
  TfrmReports = class(TfrmHSplit)
    ...
    procedure Splitter1CanResize(Sender: TObject; var NewSize: Integer;
      var Accept: Boolean);
// AA   procedure WebBrowser1DocumentComplete(Sender: TObject;
// AA     const pDisp: IDispatch; var URL: OleVariant);
    ...
    procedure WebBrowser1DocumentComplete(ASender: TObject;
      const pDisp: IDispatch; const URL: OleVariant); // AA
...
var
  ...
  uRptID: String;
  uDirect: String;
  uEmptyImageList: TImageList = nil; // AA
...
procedure TfrmReports.WebBrowser1DocumentComplete(ASender: TObject;
...
// AA uEmptyImageList := TImageList.Create(Self);
// AA uEmptyImageList.Width := 0;
