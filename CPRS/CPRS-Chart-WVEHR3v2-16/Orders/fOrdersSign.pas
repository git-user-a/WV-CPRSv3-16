...
uses
  XWBHash, rCore, rOrders, uConst, fOrdersPrint, uCore, uOrders, uSignItems, fOrders,
...
//AA		    pnlTop.Height := pnlTop.Height - ShrinkHeight;
//AA        pnlCombined.Top := pnlCombined.Top - ShrinkHeight;
//AA		    pnlCombined.Height := pnlCombined.Height + ShrinkHeight;
...
begin
  ...
  if  BILLING_AWARE then
      begin
//AA        clstOrders.Height := 228;
//AA        clstOrders.Top :=  (gbdxLookup.top + 65);
...
begin
//AA  fraCoPay.LabelCaptionsOn(not FOSTFHintWndActive)
end;
