...
implementation
//agp wv add uCore for Hide Patient SSN
uses rCore, VA508AccessibilityRouter, uCombatVet, uCore;
...
begin
  ...
  begin
    ...
    if HRN <> '' then Memo.Lines.Add(lblPtHRN.Caption + ' HRN: ' + HRN)
    else Memo.Lines.Add(lblPtHRN.Caption);
    //agp wb end change
